...
const entityLabels: Record<string, string> = { EmployeeReferencePhoto: 'รูปอ้างอิงพนักงาน', EmployeeLicenseDocument: 'ใบอนุญาต', EmployeeLicense: 'ใบอนุญาต', LeaveRequest: 'คำขอลา', ShiftAssignment: 'ตารางเวร', ScheduleApproval: 'การอนุมัติตารางเวร', User: 'บัญชีผู้ใช้', Employee: 'ข้อมูลพนักงาน', EmployeeLifecycleEvent: 'วงจรพนักงาน' };
