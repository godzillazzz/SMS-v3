...
export function LeaveSummaryCard({ summary, loading, canManage, canAdmin, onNavigate }: LeaveSummaryCardProps) {
  ...
  return <section className="dashboard-panel dashboard-leave-summary" aria-label="สรุปการลา">
    <header className="dashboard-panel__header"><div><p>LEAVE & QUOTA</p><h2>การลาและโควตาวันลา</h2></div><button type="button" className="dashboard-link-button" onClick={() => onNavigate('leaveHistory')}>ดูทั้งหมด</button></header>
