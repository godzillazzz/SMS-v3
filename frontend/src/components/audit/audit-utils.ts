...
const entityLabels: Record<string, string> = { Employee: 'พนักงาน', EmployeeLifecycleEvent: 'ประวัติวงจรพนักงาน', EmployeeLicense: 'ใบอนุญาตพนักงาน', EmployeeLicenseDocument: 'เอกสารใบอนุญาต', LeaveRequest: 'คำขอลา', LeaveQuota: 'โควต้าวันลา', ShiftAssignment: 'รายการกะ', ShiftType: 'ประเภทกะ', ScheduleApproval: 'การอนุมัติตาราง', SchedulingRule: 'กฎการทำงาน', User: 'ผู้ใช้', UserCredential: 'ข้อมูลรับรองผู้ใช้', ViewAsSession: 'ดูแทนผู้ใช้', SystemSetting: 'การตั้งค่าระบบ' };
