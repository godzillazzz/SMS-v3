...
const entityLabels: Record<string, string> = { Employee: 'พนักงาน', EmployeeLifecycleEvent: 'ประวัติวงจรพนักงาน', EmployeeLicense: 'ใบอนุญาตพนักงาน', EmployeeReferencePhoto: 'รูปอ้างอิงพนักงาน', EmployeeLicenseDocument: 'เอกสารใบอนุญาต', LeaveRequest: 'คำขอลา', LeaveQuota: 'โควต้าวันลา', LeaveTypeMaster: 'ประเภทการลา', ShiftAssignment: 'รายการกะ', ShiftType: 'ประเภทกะ', ScheduleApproval: 'การอนุมัติตาราง', SchedulingRule: 'กฎการทำงาน', AutoSchedulePattern: 'แพทเทิร์นจัดกะอัตโนมัติ', DepartmentMaster: 'Department Master', PositionMaster: 'Position Master', ApprovalAuthorityPolicy: 'นโยบายสิทธิ์อนุมัติ', SecuritySite: 'Security Site', SecuritySiteDepartment: 'Department ↔ Site', SecuritySiteQrCredential: 'ข้อมูลรับรอง QR ของ Site', RetentionPolicyChange: 'การเปลี่ยนนโยบาย Retention', DataRetentionCleanupRun: 'รอบ Cleanup ตาม Retention', User: 'ผู้ใช้', UserCredential: 'ข้อมูลรับรองผู้ใช้', ViewAsSession: 'ดูแทนผู้ใช้', SystemSetting: 'การตั้งค่าระบบ' };
