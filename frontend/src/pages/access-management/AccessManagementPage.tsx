...
import { G06UatProvisioningPanel, type G06UatProvisionResult } from './G06UatProvisioningPanel';
...
type Props = {
  ...
  onOpenAudit(): void;
  onProvisionG06Uat?: () => Promise<G06UatProvisionResult>;
};

type Dialog = 'edit' | 'approve' | 'reset' | 'view-as' | 'confirm' | undefined;
type ModalTone = 'default' | 'positive' | 'warning' | 'danger';

const roleLabel: Record<string, string> = ROLE_MANAGEMENT_LABEL;
