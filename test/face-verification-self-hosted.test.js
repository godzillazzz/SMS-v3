...
test('self-hosted orchestration requires private evidence before issuing an Attendance receipt', async () => {
  const c = context();
...
test('successful self-hosted evaluation fails closed when mandatory evidence storage is unavailable', async () => {
...
test('self-hosted verifier compensates stored evidence when receipt authority fails', async () => {
