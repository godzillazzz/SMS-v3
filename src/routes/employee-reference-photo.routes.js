...
router.get('/employee/:employeeId', authorize('ADMIN', 'MANAGER', 'SUPERVISOR'), async (req, res, next) => {
...
router.post('/employee/:employeeId', authorize('ADMIN', 'MANAGER', 'SUPERVISOR'), photoUpload, async (req, res, next) => {
...
router.get('/:id/view', authorize('ADMIN', 'MANAGER', 'SUPERVISOR'), async (req, res, next) => {
...
router.post('/:id/cancel', authorize('MANAGER', 'SUPERVISOR'), async (req, res, next) => {
