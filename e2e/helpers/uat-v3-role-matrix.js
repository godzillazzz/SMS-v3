...
const roleApiMatrix = {
  ADMIN: [
    ...
    ['System Health', '/api/v1/admin/system-health', 200, 'src/routes/system-health.routes.js', 'authorize ADMIN'],
  ...
  MANAGER: [
    ...
    ['System Health', '/api/v1/admin/system-health', 403, 'src/routes/system-health.routes.js', 'authorize ADMIN'],
