...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **1. Real Notification Channel**| Activation Blocked | Notification Owner | Signed channel choice matrix | Select and configure provider | Delivery verified in console | **BLOCKED** |
