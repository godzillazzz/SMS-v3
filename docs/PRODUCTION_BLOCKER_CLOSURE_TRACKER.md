...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **1. Real Notification Channel**| Selected category | Notification Owner | Signed channel choice matrix | Select and configure provider | Delivery verified in console | **CONDITIONALLY CLEARED** |
