...
| **8. Backup Schedule** | Staging Test Passed | Backup Owner | Windows Task Scheduler configurations| Activate task scheduling | Trigger logs recorded | **CONDITIONALLY CLEARED** |
| **9. Restore Rehearsal** | Staging Test Passed | Restore-Test Owner | Rehearsal task configurations | Activate weekly rehearsal task | Rehearsal logs clean | **CONDITIONALLY CLEARED** |
