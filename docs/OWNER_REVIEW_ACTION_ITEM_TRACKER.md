...
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **Assign Application Owner** | Business Owner | Staff assignment | None | Signed role mapping sheet | **OPEN** | Blocks production release |
| **Assign Technical Owner** | Business Owner | Staff assignment | None | Signed role mapping sheet | **OPEN** | Blocks staging acceptance |
| **Assign Database Owner** | Business Owner | Staff assignment | None | Signed role mapping sheet | **OPEN** | Blocks data migration |
| **Assign Security Owner** | Business Owner | Staff assignment | None | Signed role mapping sheet | **OPEN** | Blocks security sign-off |
| **Assign Privacy/PDPA Owner**| Business Owner | Staff assignment | None | Signed role mapping sheet | **OPEN** | Blocks PDPA review |
| **Assign Infrastructure Owner**| Business Owner | Staff assignment | None | Signed role mapping sheet | **OPEN** | Blocks production deployment|
...
| **Approve Pilot Participants** | Application Owner | Tester list | DEC-02 | Anonymized user listing sheet| **OPEN** | Blocks staging pilot start |
