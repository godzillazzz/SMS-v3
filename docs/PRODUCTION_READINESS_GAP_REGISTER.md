...
| **18. Old Vercel Project Review** | Staging-only linked | vercel.json configuration | Audit of any separate legacy Vercel proj | Stray legacy environment leakage | Technical Owner | Legacy review sign-off | Decommissioning report | **BLOCKER** |
